...
module Vivino
  ...
  # A Page object implementation for 'Home', this page usually appears right after user sign-up/sign-in page
  # and when clicking 'Try us out' at the last page of 'How it Works' slider
